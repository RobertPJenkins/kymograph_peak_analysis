kymograph_peak_analysis Licence Agreement

©2022, The Francis Crick Institute

kymograph_peak_analysis: Code to generate features desribing kymographs generated in the lab.

All files in this distribution are part of kymograph_peak_analysis.

kymograph_peak_analysis is available here: https://github.com/RobertPJenkins/kymograph_peak_analysis

kymograph_peak_analysis is distributed under the terms of the CRICK Non-commercial Licence Agreement v 2.0.
...
Authors shall mean Robert P. Jenkins
...
Software shall mean the Organoid Growth Analysis to which the Agreement applies.
...
The Licensee agrees to acknowledge the organoid_growth_analysis research project with appropriate citations in any publication or presentation containing research results obtained in whole or in part through the use of the Software. Specifically, the Licensee agrees to cite:
